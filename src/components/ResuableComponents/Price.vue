<template>
     <div class="lg:pt-6 w-11/12 mx-auto md:w-8/12 lg:w-4/12 px-4 text-center">
        <div
        ...
        >
          <div class="px-4 py-16 flex-auto">
            ...
            <div class="flex justify-center">
              ...
              <h3
                class="mb-1 text-2xl font-title font-semibold text-gray-800 lg:text-2xl"
              >
                &nbsp;{{ coverage }}
              </h3>
            </div>
  ...
  <!-- <div class="relative py-10 md:py-16 shadow-lg rounded-xl mx-2 w-10/12 md:w-8/12 mb-6">
    <h2
      class="mb-1 text-2xl md:text-3xl font-title tracking-wide font-semibold text-salmon lg:text-3xl"
    >
      {{ plan }}
